...
foreach ( array(
    'core_sys_conf_settings' => array( 'conf_app=?', $appDir ),
    'core_modules'           => array( 'sys_module_application=?', $appDir ),
    'core_hooks'             => array( 'app=?', $appDir ),
    'core_tasks'             => array( 'app=?', $appDir ),
    'core_widgets'           => array( 'app=?', $appDir ),
    'core_sys_lang_words'    => array( 'word_app=?', $appDir ),
    'core_theme_templates'   => array( 'template_app=?', $appDir ),
    'core_applications'      => array( 'app_directory=?', $appDir ),
) as $table => $where )
{
